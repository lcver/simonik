        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div id="presultData">
                        @include('app.dataPengawas.presult')
                    </div>
                </div>
                <!-- /.card -->
            </div>
    ...
    @if(session('alertDestroy'))
        <script>
            $(document).Toasts('create', {
                ...
                body: 'Berhasil Menghapus Data Pengawas <b>{{ session("alertDestroy") }}</b>'
            })
        </script>
    @elseif(session('alertCreate'))
        <script>
            $(document).Toasts('create', {
                ...
                class: 'bg-success',
                position: 'bottomRight',
                body: 'Berhasil Menambah Data Pengawas <b>{{ session("alertCreate") }}</b>'
            })
        </script>
    @elseif(session('alertUpdate'))
        <script>
            $(document).Toasts('create', {
                ...
                class: 'bg-success',
                position: 'bottomRight',
                body: 'Berhasil Memperbarui Data Pengawas <b>{{ session("alertUpdate") }}</b>'
            })
        </script>
    @endif
@endsection
